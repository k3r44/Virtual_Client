...
def open(name: "str"=None) -> "virConnect":
    """This function should be called first to get a connection to the
...
def openReadOnly(name: "str"=None) -> "virConnect":
...
def virEventRegisterImpl(addHandle: "_EventAddHandleFunc[_T]", updateHandle: "_EventUpdateHandleFunc", removeHandle: "_EventRemoveHandleFunc", addTimeout: "_EventAddTimeoutFunc[_T]", updateTimeout: "_EventUpdateTimeoutFunc", removeTimeout: "_EventRemoveTimeoutFunc") -> "None":
...
class virDomain(object):
    def __init__(self, conn: "virConnect", _obj: object=None):
        self._conn = conn
    ...
    def abortJobFlags(self, flags: "int"=0) -> "int":
        """Requests that the current background job be aborted at the
        soonest opportunity. In case the job is a migration in a post-copy mode,
    ...
    def addIOThread(self, iothread_id: "int", flags: "int"=0) -> "int":
    ...
    def agentSetResponseTimeout(self, timeout: "int", flags: "int"=0) -> "int":
    ...
    def attachDeviceFlags(self, xml: "str", flags: "int"=0) -> "int":
    ...
    def authorizedSSHKeysGet(self, user: "str", flags: "int"=0) -> "str":
    ...
    def authorizedSSHKeysSet(self, user: "str", keys: "str"=None, flags: "int"=0) -> "int":
    ...
    def backupBegin(self, backupXML: "str", checkpointXML: "str", flags: "int"=0) -> "int":
    ...
    def backupGetXMLDesc(self, flags: "int"=0) -> "str":
    ...
    def blkioParameters(self, flags: "int"=0) -> "str":
    ...
    def blockCommit(self, disk: "str", base: "str", top: "str", bandwidth: "int"=0, flags: "int"=0) -> "int":
    ...
    def blockCopy(self, disk: "str", destxml: "str", params: "_TypedParameter"=None, flags: "int"=0) -> "int":
    ...
    def blockInfo(self, path: "str", flags: "int"=0) -> "str":
    ...
    def blockIoTune(self, disk: "str", flags: "int"=0) -> "str":
    ...
    def blockJobAbort(self, disk: "str", flags: "int"=0) -> "int":
    ...
    def blockJobInfo(self, path: "str", flags: "int"=0) -> "str":
    ...
    def blockJobSetSpeed(self, disk: "str", bandwidth: "int", flags: "int"=0) -> "int":
    ...
    def blockPeek(self, disk: "str", offset: "int", size: "int", flags: "int"=0) -> "str":
    ...
    def blockPull(self, disk: "str", bandwidth: "int"=0, flags: "int"=0) -> "int":
    ...
    def blockRebase(self, disk: "str", base: "str", bandwidth: "int"=0, flags: "int"=0) -> "int":
    ...
    def blockResize(self, disk: "str", size: "int", flags: "int"=0) -> "int":
    ...
    def blockStats(self, path: "str") -> "str":
    ...
    def blockStatsFlags(self, path: "str", flags: "int"=0) -> "str":
    ...
    def checkpointCreateXML(self, xmlDesc: "str", flags: "int"=0) -> "virDomainCheckpoint":
    ...
    def checkpointLookupByName(self, name: "str", flags: "int"=0) -> "virDomainCheckpoint":
    ...
    def controlInfo(self, flags: "int"=0) -> "str":
    ...
    def coreDump(self, to: "str", flags: "int"=0) -> "int":
    ...
    def coreDumpWithFormat(self, to: "str", dumpformat: "int", flags: "int"=0) -> "int":
        """This method will dump the core of a domain on a given file for analysis.
        Note that for remote Xen Daemon the file path will be interpreted in
        the remote host. Hypervisors may require  the user to manually ensure
        proper permissions on the file named by @to.
    ...
    def createWithFlags(self, flags: "int"=0) -> "int":
        """Launch a defined domain. If the call succeeds the domain moves from the
    ...
    def delIOThread(self, iothread_id: "int", flags: "int"=0) -> "int":
    ...
    def destroyFlags(self, flags: "int"=0) -> "int":
        """Destroy the domain object. The running instance is shutdown if not down
    ...
    def detachDeviceAlias(self, alias: "str", flags: "int"=0) -> "int":
    ...
    def detachDeviceFlags(self, xml: "str", flags: "int"=0) -> "int":
    ...
    def diskErrors(self, flags: "int"=0) -> "str":
    ...
    def emulatorPinInfo(self, flags: "int"=0) -> "str":
    ...
    def fSTrim(self, mountPoint: "str", minimum: "int", flags: "int"=0) -> "int":
    ...
    def fsInfo(self, flags: "int"=0) -> "str":
    ...
    def getCPUStats(self, total: "bool", flags: "int"=0) -> "str":
    ...
    def guestInfo(self, types: "int"=0, flags: "int"=0) -> "str":
    ...
    def guestVcpus(self, flags: "int"=0) -> "int":
    ...
    def hasCurrentSnapshot(self, flags: "int"=0) -> "int":
    ...
    def hasManagedSaveImage(self, flags: "int"=0) -> "int":
    ...
    def hostname(self, flags: "int"=0) -> "str":
    ...
    def interfaceAddresses(self, source: "int", flags: "int"=0) -> "str":
    ...
    def interfaceParameters(self, device: "str", flags: "int"=0) -> "str":
    ...
    def interfaceStats(self, path: "str") -> "str":
    ...
    def ioThreadInfo(self, flags: "int"=0) -> "str":
    ...
    def jobStats(self, flags: "int"=0) -> "str":
        """Extract information about an active job being processed for a domain. """
    ...
    def launchSecurityInfo(self, flags: "int"=0) -> "str":
    ...
    def managedSave(self, flags: "int"=0) -> "int":
    ...
    def managedSaveDefineXML(self, dxml: "str", flags: "int"=0) -> "int":
    ...
    def managedSaveGetXMLDesc(self, flags: "int"=0) -> "str":
    ...
    def managedSaveRemove(self, flags: "int"=0) -> "int":
    ...
    def memoryParameters(self, flags: "int"=0) -> "str":
    ...
    def memoryPeek(self, start: "int", size: "int", flags: "int"=0) -> "str":
    ...
    def messages(self, flags: "int"=0) -> "str":
    ...
    def metadata(self, type: "int", uri: "str", flags: "int"=0) -> "str":
    ...
    def migrate(self, dconn: "virConnect", flags: "int"=0, dname: "str"=None, uri: "str"=None, bandwidth: "int"=0) -> "virDomain":
    ...
    def migrate2(self, dconn: "virConnect", dxml: "str"=None, flags: "int"=0, dname: "str"=None, uri: "str"=None, bandwidth: "int"=0) -> "virDomain":
        """Migrate the domain object from its current host to the destination
        host given by dconn (a connection to the destination host).
    ...
    def migrate3(self, dconn: "virConnect", params: "str", flags: "int"=0) -> "virDomain":
    ...
    def migrateGetCompressionCache(self, flags: "int"=0) -> "int":
    ...
    def migrateGetMaxDowntime(self, flags: "int"=0) -> "int":
    ...
    def migrateGetMaxSpeed(self, flags: "int"=0) -> "int":
    ...
    def migrateSetCompressionCache(self, cacheSize: "int", flags: "int"=0) -> "int":
    ...
    def migrateSetMaxDowntime(self, downtime: "int", flags: "int"=0) -> "int":
    ...
    def migrateSetMaxSpeed(self, bandwidth: "int", flags: "int"=0) -> "int":
    ...
    def migrateStartPostCopy(self, flags: "int"=0) -> "int":
    ...
    def migrateToURI(self, duri: "str", flags: "int"=0, dname: "str"=None, bandwidth: "int"=0) -> "int":
        """Migrate the domain object from its current host to the destination
        host given by duri.
    ...
    def migrateToURI2(self, dconnuri: "str"=None, miguri: "str"=None, dxml: "str"=None, flags: "int"=0, dname: "str"=None, bandwidth: "int"=0) -> "int":
        """Migrate the domain object from its current host to the destination
    ...
    def migrateToURI3(self, dconnuri: "str", params: "str", flags: "int"=0) -> "int":
        """Migrate the domain object from its current host to the destination host
                    given by URI. """
    ...
    def numaParameters(self, flags: "int"=0) -> "str":
    ...
    def openChannel(self, name: "str", st: "virStream", flags: "int"=0) -> "int":
    ...
    def openConsole(self, dev_name: "str", st: "virStream", flags: "int"=0) -> "int":
    ...
    def openGraphics(self, idx: "int", fd: "int", flags: "int"=0) -> "int":
    ...
    def pMSuspendForDuration(self, target: "int", duration: "int", flags: "int"=0) -> "int":
    ...
    def pMWakeup(self, flags: "int"=0) -> "int":
    ...
    def perfEvents(self, flags: "int"=0) -> "str":
    ...
    def pinEmulator(self, cpumap: "str", flags: "int"=0) -> "int":
    ...
    def pinIOThread(self, iothread_val: "int", cpumap: "str", flags: "int"=0) -> "int":
    ...
    def pinVcpu(self, vcpu: "int", cpumap: "str") -> "int":
    ...
    def pinVcpuFlags(self, vcpu: "int", cpumap: "str", flags: "int"=0) -> "int":
        """Dynamically change the real CPUs which can be allocated to a virtual CPU. This function requires privileged access to the hypervisor. """
    ...
    def rename(self, new_name: "str", flags: "int"=0) -> "int":
    ...
    def revertToSnapshot(self, snap: "virDomainSnapshot", flags: "int"=0) -> "int":
    ...
    def saveFlags(self, to: "str", dxml: "str"=None, flags: "int"=0) -> "int":
        """This method will suspend a domain and save its memory contents to
        a file on disk. After the call, if successful, the domain is not
        listed as running anymore (this ends the life of a transient domain).
        Use virDomainRestore() to restore a domain after saving.
    ...
    def saveParams(self, params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def schedulerParameters(self) -> "str":
    ...
    def schedulerParametersFlags(self, flags: "int"=0) -> "str":
    ...
    def screenshot(self, stream: "virStream", screen: "int", flags: "int"=0) -> "str":
    ...
    def securityLabelList(self) -> "str":
    ...
    def sendKey(self, codeset: "int", holdtime: "int", keycodes: "List[int]", nkeycodes: "int", flags: "int"=0) -> "int":
    ...
    def sendProcessSignal(self, pid_value: "int", signum: "int", flags: "int"=0) -> "int":
    ...
    def setBlkioParameters(self, params: "_BlkioParameter", flags: "int"=0) -> "int":
    ...
    def setBlockIoTune(self, disk: "str", params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def setBlockThreshold(self, dev: "str", threshold: "int", flags: "int"=0) -> "int":
    ...
    def setGuestVcpus(self, cpumap: "str", state: "int", flags: "int"=0) -> "int":
    ...
    def setIOThreadParams(self, iothread_val: "int", params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def setInterfaceParameters(self, device: "str", params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def setLaunchSecurityState(self, params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def setLifecycleAction(self, type: "int", action: "int", flags: "int"=0) -> "int":
    ...
    def setMemoryFlags(self, memory: "int", flags: "int"=0) -> "int":
        """Dynamically change the target amount of physical memory allocated to a
        domain. If domain is None, then this change the amount of memory reserved
        to Domain0 i.e. the domain where the application runs.
        This function may require privileged access to the hypervisor.
    ...
    def setMemoryParameters(self, params: "_MemoryParameter", flags: "int"=0) -> "int":
    ...
    def setMemoryStatsPeriod(self, period: "int", flags: "int"=0) -> "int":
    ...
    def setMetadata(self, type: "int", metadata: "str", key: "str", uri: "str", flags: "int"=0) -> "int":
    ...
    def setNumaParameters(self, params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def setPerfEvents(self, params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def setSchedulerParametersFlags(self, params: "_SchedParameter", flags: "int"=0) -> "int":
        """Change the scheduler parameters """
    ...
    def setUserPassword(self, user: "str", password: "str", flags: "int"=0) -> "int":
    ...
    def setVcpu(self, vcpumap: "str", state: "int", flags: "int"=0) -> "int":
    ...
    def setVcpusFlags(self, nvcpus: "int", flags: "int"=0) -> "int":
        """Dynamically change the number of virtual CPUs used by the domain.
        Note that this call may fail if the underlying virtualization hypervisor
        does not support it or if growing the number is arbitrarily limited.
        This function may require privileged access to the hypervisor.
    ...
    def shutdownFlags(self, flags: "int"=0) -> "int":
        """Shutdown a domain, the domain object is still usable thereafter but
        the domain OS is being stopped. Note that the guest OS may ignore the
        request. Additionally, the hypervisor may check and support the domain
        'on_poweroff' XML setting resulting in a domain that reboots instead of
    ...
    def snapshotCreateXML(self, xmlDesc: "str", flags: "int"=0) -> "virDomainSnapshot":
    ...
    def snapshotCurrent(self, flags: "int"=0) -> "virDomainSnapshot":
    ...
    def snapshotListNames(self, flags: "int"=0) -> "str":
    ...
    def snapshotLookupByName(self, name: "str", flags: "int"=0) -> "virDomainSnapshot":
    ...
    def snapshotNum(self, flags: "int"=0) -> "int":
    ...
    def startDirtyRateCalc(self, seconds: "int", flags: "int"=0) -> "int":
    ...
    def state(self, flags: "int"=0) -> "str":
    ...
    def vcpuPinInfo(self, flags: "int"=0) -> "str":
...
class virNetwork(object):
    ...
    def DHCPLeases(self, mac: "str"=None, flags: "int"=0) -> "str":
    ...
    def portCreateXML(self, xmldesc: "str", flags: "int"=0) -> "virNetworkPort":
    ...
    def portLookupByUUID(self, uuid: "str") -> "virNetworkPort":
    ...
    def update(self, command: "int", section: "int", parentIndex: "int", xml: "str", flags: "int"=0) -> "int":
...
class virNetworkPort(object):
    def __init__(self, net: "virNetwork", _obj: object=None) -> None:
        self._net = net
    ...
    def parameters(self, flags: "int"=0) -> "str":
    ...
    def setParameters(self, params: "_TypedParameter", flags: "int"=0) -> "int":
...
class virInterface(object):
    ...
    def destroy(self, flags: "int"=0) -> "int":
...
class virStoragePool(object):
    ...
    def build(self, flags: "int"=0) -> "int":
    ...
    def createXML(self, xmlDesc: "str", flags: "int"=0) -> "virStorageVol":
    ...
    def createXMLFrom(self, xmlDesc: "str", clonevol: "virStorageVol", flags: "int"=0) -> "virStorageVol":
...
class virStorageVol(object):
    ...
    def download(self, stream: "virStream", offset: "int", length: "int", flags: "int"=0) -> "int":
    ...
    def infoFlags(self, flags: "int"=0) -> "str":
        """Extract information about a storage volume. Note that if the connection used to get the domain is limited only a partial set of the information can be extracted. """
    ...
    def resize(self, capacity: "int", flags: "int"=0) -> "int":
    ...
    def upload(self, stream: "virStream", offset: "int", length: "int", flags: "int"=0) -> "int":
    ...
    def wipePattern(self, algorithm: "int", flags: "int"=0) -> "int":
...
class virConnect(object):
    ...
    def allocPages(self, pages: "str", startCell: "int"=0, cellCount: "int"=0, flags: "int"=0) -> "int":
    ...
    def baselineCPU(self, xmlCPUs: "List[str]", flags: "int"=0) -> "str":
    ...
    def baselineHypervisorCPU(self, emulator: "str", arch: "str", machine: "str", virttype: "str", xmlCPUs: "List[str]", flags: "int"=0) -> "str":
    ...
    def changeBegin(self, flags: "int"=0) -> "int":
    ...
    def changeCommit(self, flags: "int"=0) -> "int":
    ...
    def changeRollback(self, flags: "int"=0) -> "int":
    ...
    def compareCPU(self, xmlDesc: "str", flags: "int"=0) -> "int":
    ...
    def compareHypervisorCPU(self, emulator: "str", arch: "str", machine: "str", virttype: "str", xmlCPU: "str", flags: "int"=0) -> "int":
    ...
    def createLinux(self, xmlDesc: "str", flags: "int"=0) -> "virDomain":
    ...
    def createXML(self, xmlDesc: "str", flags: "int"=0) -> "virDomain":
    ...
    def defineXMLFlags(self, xml: "str", flags: "int"=0) -> "virDomain":
    ...
    def domainXMLFromNative(self, nativeFormat: "str", nativeConfig: "str", flags: "int"=0) -> "str":
    ...
    def domainXMLToNative(self, nativeFormat: "str", domainXml: "str", flags: "int"=0) -> "str":
    ...
    def findStoragePoolSources(self, type: "str", srcSpec: "str", flags: "int"=0) -> "str":
    ...
    def getCPUMap(self, flags: "int"=0) -> "str":
    ...
    def getCPUModelNames(self, arch: "str", flags: "int"=0) -> "str":
    ...
    def getCPUStats(self, cpuNum: "int", flags: "int"=0) -> "str":
    ...
    def getCellsFreeMemory(self, startCell: "int", maxCells: "int") -> "str":
    ...
    def getDomainCapabilities(self, emulatorbin: "str"=None, arch: "str"=None, machine: "str"=None, virttype: "str"=None, flags: "int"=0) -> "str":
    ...
    def getFreePages(self, pages: "str", startCell: "int", maxCells: "int", flags: "int"=0) -> "str":
    ...
    def getMemoryParameters(self, flags: "int"=0) -> "str":
    ...
    def getMemoryStats(self, cellNum: "int", flags: "int"=0) -> "str":
    ...
    def getSEVInfo(self, flags: "int"=0) -> "str":
    ...
    def getStoragePoolCapabilities(self, flags: "int"=0) -> "str":
    ...
    def getSysinfo(self, flags: "int"=0) -> "str":
    ...
    def interfaceDefineXML(self, xml: "str", flags: "int"=0) -> "virInterface":
    ...
    def listDefinedDomains(self) -> "str":
    ...
    def listDefinedInterfaces(self) -> "str":
    ...
    def listDefinedNetworks(self) -> "str":
    ...
    def listDefinedStoragePools(self) -> "str":
    ...
    def listDevices(self, cap: "str", flags: "int"=0) -> "str":
    ...
    def networkCreateXMLFlags(self, xmlDesc: "str", flags: "int"=0) -> "virNetwork":
        """Create and start a new virtual network, based on an XML description
        similar to the one returned by virNetworkGetXMLDesc()
    ...
    def networkDefineXMLFlags(self, xml: "str", flags: "int"=0) -> "virNetwork":
        """Define an inactive persistent virtual network or modify an existing
        persistent one from the XML description.
    ...
    def networkLookupByUUID(self, uuid: "str") -> "virNetwork":
    ...
    def newStream(self, flags: "int"=0) -> "virStream":
    ...
    def nodeDeviceCreateXML(self, xmlDesc: "str", flags: "int"=0) -> "virNodeDevice":
    ...
    def nodeDeviceDefineXML(self, xmlDesc: "str", flags: "int"=0) -> "virNodeDevice":
    ...
    def nodeDeviceLookupSCSIHostByWWN(self, wwnn: "str", wwpn: "str", flags: "int"=0) -> "virNodeDevice":
    ...
    def numOfDevices(self, cap: "str", flags: "int"=0) -> "int":
    ...
    def nwfilterBindingCreateXML(self, xml: "str", flags: "int"=0) -> "virNWFilterBinding":
    ...
    def nwfilterDefineXMLFlags(self, xmlDesc: "str", flags: "int"=0) -> "virNWFilter":
        """Define a new network filter, based on an XML description
        similar to the one returned by virNWFilterGetXMLDesc()
    ...
    def nwfilterLookupByUUID(self, uuid: "str") -> "virNWFilter":
    ...
    def restoreFlags(self, frm: "str", dxml: "str"=None, flags: "int"=0) -> "int":
        """This method will restore a domain saved to disk by virDomainSave().
    ...
    def restoreParams(self, params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def saveImageDefineXML(self, file: "str", dxml: "str", flags: "int"=0) -> "int":
        """This updates the definition of a domain stored in a saved state
    ...
    def saveImageGetXMLDesc(self, file: "str", flags: "int"=0) -> "str":
    ...
    def secretDefineXML(self, xml: "str", flags: "int"=0) -> "virSecret":
    ...
    def secretLookupByUUID(self, uuid: "str") -> "virSecret":
    ...
    def setIdentity(self, params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def setMemoryParameters(self, params: "_TypedParameter", flags: "int"=0) -> "int":
    ...
    def storagePoolCreateXML(self, xmlDesc: "str", flags: "int"=0) -> "virStoragePool":
    ...
    def storagePoolDefineXML(self, xml: "str", flags: "int"=0) -> "virStoragePool":
    ...
    def storagePoolLookupByUUID(self, uuid: "str") -> "virStoragePool":
    ...
    def suspendForDuration(self, target: "int", duration: "int", flags: "int"=0) -> "int":
    ...
    def virConnGetLastError(self) -> "_RawError":
...
class virNodeDevice(object):
    ...
    def detachFlags(self, driverName: "str", flags: "int"=0) -> "int":
    ...
    def undefine(self, flags: "int"=0) -> "int":
...
class virSecret(object):
    ...
    def setValue(self, value: "str", flags: "int"=0) -> "int":
    ...
    def value(self, flags: "int"=0) -> "str":
...
class virDomainCheckpoint(object):
    def __init__(self, dom: "virDomain", _obj: object=None):
        self._dom = dom
    ...
    def getParent(self, flags: "int"=0) -> "virDomainCheckpoint":
...
class virDomainSnapshot(object):
    ...
    def getParent(self, flags: "int"=0) -> "virDomainSnapshot":
    ...
    def hasMetadata(self, flags: "int"=0) -> "int":
    ...
    def isCurrent(self, flags: "int"=0) -> "int":
    ...
    def listChildrenNames(self, flags: "int"=0) -> "str":
    ...
    def numChildren(self, flags: "int"=0) -> "int":
