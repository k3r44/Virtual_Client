...
def qemuAgentCommand(domain: "virDomain", cmd: "str", timeout: "int", flags: "int") -> "str":
...
def qemuAttach(conn: "virConnect", pid_value: "int", flags: "int") -> "virDomain":
    """This API is QEMU specific, so it will only work with hypervisor
...
def qemuMonitorCommand(domain: "virDomain", cmd: "str", flags: "int") -> "str":
